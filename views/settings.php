        ...
        <div class="row mw-100 ms-0 row-gap-3 mt-3">
            <div class="col-12 col-md-12">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link <?php echo (($_SERVER['REQUEST_URI'] == '/settings') ? " active text-dark"
                            : "text-dark" )?>" aria-current="page" href="/settings">Manage Account</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo (str_contains($_SERVER['REQUEST_URI'], '/settings?view=about') ? "
                            active text-dark" : "text-dark" )?>" aria-current="page" href="/settings?view=about">Site
                            Information</a>
                    </li>
                </ul>
            </div>
                        ...
                        <form method="POST" action="/account/edit">
                            ...
                            <div class="form-floating mb-3">
                                <input type="datetime-local" name="last_email" class="form-control" id="last_email"
                                    placeholder="last_email" value="<?php echo($user->last_email) ?>" required=""
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="threshold" class="form-control" id="threshold"
                                    placeholder="threshold" required="" value="<?php echo($user->email_threshold) ?>"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-floating">
                                        <input type="password" name="new_password_confirm" class="form-control"
                                            id="new_password_confirm" placeholder="new_password_confirm">
